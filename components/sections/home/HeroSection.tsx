      ...
      <div className="relative z-10 flex flex-col items-end justify-end h-full min-h-screen pb-50 px-8 sm:px-14 md:px-20 lg:px-26.25">
        <div className="max-w-172.5">
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
           className="fixed bottom-16 md:bottom-20 right-10 sm:right-16 md:right-24 lg:right-31.75 inline-flex items-center gap-3 bg-background hover:underline text-foreground text-[14.21px] leading-[21.32px] pl-20 pr-[8.5px] pt-1 pb-1.5 rounded-[7px] transition-colors z-50">
            <Image
