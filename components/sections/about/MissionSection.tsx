        ...
        <div className="px-12 sm:px-14 md:px-18 lg:px-21.25 py-14 md:py-19.5 flex flex-col gap-6 md:gap-10.5">
          ...
          <blockquote className="border-l-3 border-[#289238] pl-7">
            <p className="text-[1rem] md:text-[1.333125rem] leading-6 md:leading-[35.56px] font-semibold">
              To empower investors and organizations by transforming
              agricultural concepts into high-performing industrial realities
              through expert technical advisory, precision project
              implementation, and sustainable value chain optimization.
            </p>
          </blockquote>
        </div>
