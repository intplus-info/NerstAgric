    ...
    <section className="w-full px-12 sm:px-18 md:px-24 lg:px-27.5 py-16 md:py-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 lg:gap-30.5 items-start">
        ...
        <div className="bg-[#F4F8FB] p-10.5 flex flex-col gap-5">
          ...
          <form className="flex flex-col gap-5.25">
            <div>
            ...
            <button
              type="submit"
              className="w-full bg-primary hover:bg-primary-light text-white text-[0.75rem] md:text-[0.875rem] leading-normal tracking-[0.015em] border rounded-[5px] px-3 py-[14.5px] transition-colors mt-2"
            >
              Send Message
            </button>
          </form>
